...
const defaultClasses =
	'mx-auto md:mx-2 w-36 rounded-md bg-slate-800 dark:bg-white  leading-8';
const disabledClasses = `block cursor-default dark:text-sky-800 self-center border border-none border-transparent  px-2.5 py-2 text-center font-sans text-sm md:text-lg font-bold shadow-sm ${defaultClasses}`;
