	...
	return (
		<div className='visible fixed top-5 right-5 z-20 flex w-56 items-end justify-end safe-top sm:hidden'>
			<Menu as='div' className='relative inline-block text-left'>
				<div>
					<Menu.Button className='inline-flex w-full justify-center rounded-md bg-black bg-opacity-20 p-2 text-sm font-medium hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75'>
						<MenuIcon
				...
				>
					<Menu.Items className='absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none'>
						...
						<BurgerItem
							...
							icon={<LogoutIcon className='mr-2 h-5 w-5 text-sky-700' />}
							text='Logout'
						/>
						...
						<BurgerItem
							href='/achievements'
							icon={<LightningBoltIcon className='mr-2 h-5 w-5 text-sky-700' />}
							text='Achievements'
						/>
						<Menu.Item>
							<button
							...
							>
								{isDarkMode ? (
									...
									<MoonIcon
										className='mr-2 h-5 w-5 text-sky-700 '
										onClick={() => {
											setDarkMode(() => true);
										}}
									/>
