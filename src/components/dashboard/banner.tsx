			...
			<div className='mx-auto max-w-7xl p-3 sm:px-6 lg:px-8'>
				<div className='flex flex-wrap items-center justify-between'>
					...
					<div className='order-3 mt-2 w-full shrink-0 sm:order-2 sm:mt-0 sm:w-auto'>
						<Link href='/sponsor'>
							<p className='flex items-center justify-center rounded-md border border-transparent bg-white px-4 py-2 text-sm font-medium text-sky-600 shadow-sm hover:bg-sky-50'>
								Learn more
							</p>
						</Link>
					</div>
