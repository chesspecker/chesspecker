	...
	return (
		<div className='flex flex-col w-screen min-h-screen px-2 pt-32 pb-24 m-0 sm:px-12'>
			<div>
				...
				<button
					className='p-4 mb-6 text-gray-100 rounded-lg cursor-pointer no-wrap w-fit disabled:cursor-not-allowed disabled:bg-slate-400 disabled:dark:bg-slate-500 disabled:text-slate-200 dark:disabled:text-slate-200 hover:disabled:dark:text-slate-200 dark:text-sky-600 hover:dark:text-sky-800 disabled:hover:dark:text-sky-600 bg-sky-700 hover:text-sky-700 hover:bg-gray-200 dark:bg-gray-100 dark:hover:bg-gray-200'
